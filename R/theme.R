...
theme_ukfsr <- function(base_size = 14, 
  ...
  t <- ggplot2::theme_void() %+replace% 
    ...
    axis.text.x =        ggplot2::element_text(margin = ggplot2::margin(t = 2.8 * half_line / 2), vjust = 1),
    # axis.text.x.top =    ggplot2::element_text(margin = margin(b = 0.8 * half_line / 2), vjust = 0),
    axis.text.y =        ggplot2::element_text(margin = ggplot2::margin(r = 2.8 * half_line / 2), hjust = 1),
